...
object Instructions {
  ...
  // Logical operations
  val AND     = BitPat("b0000000??????????111?????0110011") // 2.4
  val OR      = BitPat("b0000000??????????110?????0110011") // 2.4
  val XOR     = BitPat("b0000000??????????100?????0110011") // 2.4
  val ANDI    = BitPat("b?????????????????111?????0010011") // 2.4
  val ORI     = BitPat("b?????????????????110?????0010011") // 2.4
  val XORI    = BitPat("b?????????????????100?????0010011") // 2.4
